...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  AgentStatus: 'core.md',
  BidReviewLimits: 'bid-review.md',
  BidReviewSetQualificationsRequest: 'bid-review.md',
  BidReviewSetQualificationsResult: 'bid-review.md',
  BidReviewUploadRequest: 'bid-review.md',
  BidReviewUploadResult: 'bid-review.md',
  CompanyQualifications: 'bid-review.md',
