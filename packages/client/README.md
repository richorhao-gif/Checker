...
| [`ui-bid-review/`](ui-bid-review/README.md) | Replaces the input surface with a fixed-question bid-document review composer and the shared qualifications editor. |
