...
export const zh = {
  ...
  'hero.headline': '审之有据 · 落印为凭',
  'hero.channel': '餐饮渠道 · 标书审核',
...
export const en = {
  ...
  'hero.headline': 'Reviewed with evidence, sealed with confidence',
  'hero.channel': 'Catering Channel · Bid Review',
  ...
  'todo.progress.stopped': '{active} stopped',
