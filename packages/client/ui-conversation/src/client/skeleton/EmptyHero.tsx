...
// headline, glow backdrop, and the workspace row. Pure presentation — the resident
      ...
      <div className={css.stack}>
        <div className={css.headline}>
          ...
          <span className={css.fishHitbox}>
            <BrandMark size={34} className={css.fish} />
          </span>
          <span className={css.headlineText}>{t('hero.headline')}</span>
          <span className={css.channelBadge}>{t('hero.channel')}</span>
        </div>
